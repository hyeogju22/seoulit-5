const questions = [
  ...
  { q: "학업이나 업무 목표를 달성하기 위해 투두리스트(To-Do)를 적을 때 나는?", a: "기한과 일정을 쪼개서 세부 체크박스를 만들고 하나씩 지우며 쾌감을 느친다", b: "리스트는 적어두거나 머리에 두지만, 그때그때 가장 급한 것부터 유연하게 해치운다", type: "JP" }
];

const results = {
  "ESTJ": { title: "효율 만렙 규칙 리더", desc: "체계적이고 확실한 것을 좋아하는 현실의 지배자! 흐트러짐 없는 계획과 칼 같은 실행력으로 무리를 하드캐리하는 대장 스타일입니다." },
  "ESTP": { title: "에너지 폭발 승부사", desc: "말보다 행동이 5배 빠른 트렌드세터! 매 순간 스릴과 자유를 즐기며 어떠한 위기 상황도 피지컬과 센스로 돌파합니다." },
...
// [수정 완료] 안전하게 현재 인덱스의 질문에서 타입을 가져온 후 인덱스를 증가시킵니다.
